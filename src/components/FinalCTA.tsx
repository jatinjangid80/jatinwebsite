...
export default function FinalCTA({
  ...
  return (
    <section className="final-cta-section wrap">
      <div className="final-cta-card border-glow-card">
        <div
          className="final-cta-glow"
          style={{
            background: `radial-gradient(circle at 50% 50%, ${activeColor}25, transparent 75%)`,
          }}
        />

        <div className="final-cta-content relative z-10">
          <span
            className="final-cta-tag"
          ...
          <p className="final-cta-desc">
            Let&apos;s turn your vision into a fast, scalable, and high-converting working product.
          </p>

          <div className="final-cta-actions">
            <button
              onClick={() => onScrollToSection('start-project')}
              className="final-cta-primary-btn magnetic-target"
              style={grad}
            >
            ...
            <a
              ...
              className="final-cta-wa-btn magnetic-target"
            >
            ...
            <a
              ...
              className="final-cta-email-btn magnetic-target"
            >
